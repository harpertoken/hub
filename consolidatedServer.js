...
app.get('/shared-video/:videoId', (req, res) => {
  ...
  try {
    ...
    <body>
      <div class="container">
        <header>
          <img src="/assets/tolerable-brand/tolerable-logo-alt.svg" alt="Tolerable Logo" class="logo">
          <h1>Tolerable Education</h1>
...
app.get('/shared-video-file/:videoId', (req, res) => {
  ...
  try {
    ...
    if (req.query.download === 'true') {
      res.setHeader('Content-Disposition', `attachment; filename=tolerable-education-video-${videoId}.mp4`);
    }
