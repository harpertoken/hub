...
const MainContent = () => {
  ...
  return (
    <div className="min-h-screen relative" style={{backgroundColor: '#ffffff'}}>
      ...
      <div className="w-full mx-auto px-4 md:px-8 lg:px-16 xl:px-24 relative z-10 flex flex-col pb-4" style={{ marginTop: isModalOpen ? "0px" : "80px", backgroundColor: '#ffffff' }}>
        <MobileMenu
          isOpen={isMenuOpen}
  ...
  return (
    <Router>
      <LegalProvider>
          <AudioProvider>
            <ModalProvider>
              <div className="flex flex-col min-h-screen relative m-0 p-0 overflow-x-hidden w-full" style={{backgroundColor: '#ffffff', color: '#000000'}}>
