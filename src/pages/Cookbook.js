...
import EduSearchRecipe from '../components/recipes/EduSearchRecipe';
import AILabRecipe from '../components/recipes/AILabRecipe';
import AdvFeaturesRecipe from '../components/recipes/AdvFeaturesRecipe';
import ModalRecipe from '../components/recipes/ModalRecipe';
import AIIntegrationRecipe from '../components/recipes/AIIntegrationRecipe';
import CodeEditorRecipe from '../components/recipes/CodeEditorRecipe';
import AITechRecipe from '../components/recipes/AITechRecipe';
import AIModelOrchRecipe from '../components/recipes/AIModelOrchRecipe';
import GenAIRecipeGen from '../components/recipes/GenAIRecipeGen';
